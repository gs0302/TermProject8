...
var lineDatasets = [
    {
        label: "점유율(%)",
        data: [60.9, 69.8, 65.4, 74.1, 69.6, 58., 80.8, 62.4, 52, 49, 71.6, 66.9],
        backgroundColor: "rgba(255, 99, 132, 1)",
        borderColor: "rgba(255, 99, 132, 1)",
        xAxisLabels: ["8/28", "9/4", "9/17", "9/24", "9/27", "9/30", "10/9", "10/23", "10/28", "11/5","11/13", "11/25"],
        yAxisMax: 100,
    },
    {
        label: "슈팅",
        data: [21, 9, 17, 15, 10, 18, 22, 12, 15, 12, 11, 15],
...
var barDatasets = [
    ...
    },
    {
        ...
        backgroundColor: "rgba(255, 99, 132, 1)",
        borderColor: "rgba(255, 99, 132, 1)",
        data: [68, 73, 80, 85, 77, 76, 76, 78, 44, 65, 83, 72],
        yAxisMax: 100,
    },
    {
...
function initializeBarChart() {
    ...
    myBarChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["8/28", "9/4", "9/17", "9/24", "9/27", "9/30", "10/9", "10/23", "10/28", "11/5","11/13", "11/25"],
